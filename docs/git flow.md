...
# git add exemplo.txt
# git commit -m "Adiciona alguma alteração ao exemplo.txt"
# ```
#
...
# ---
#
# Este guia cobre todo o processo de desenvolvimento usando o Git Flow, desde a criação de uma feature até a criação de um release e a atualização do repositório remoto no GitHub.
# -------------------------------
